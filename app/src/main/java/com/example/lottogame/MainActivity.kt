...
class MainActivity : AppCompatActivity() {
    ...
    private fun setButton(){
        ...
        result_button.setOnClickListener(object: View.OnClickListener{
            ...
            override fun onClick(v: View?) {
                ...
                if (isAllSelected) {
                    win_text.text = ("당첨 번호 : " + mWinNumbers[0] + " " + mWinNumbers[1] + " " +
                            mWinNumbers[2] + " " + mWinNumbers[3] + " " + mWinNumbers[4]+ " " + mWinNumbers[5]
                            + " 보너스: " + mBonusNum)
    ...
    private fun isWin(gameNumbers: Map<Int, Int>, gameNum: Int){
        if(resultWin(gameNumbers) > 5){
            ...
            mResultText.append(gameNum.toString() + "번 " + resultWin(gameNumbers)+
             "등! ")
        }
